...
# custom_csv_path = root_path / "data" / "resultado_verificacion_lado.csv.xls"
# custom_csv_path = root_path / "data" / "pois_errores.csv.xls"
custom_csv_path = root_path / "data" / "pois_validados_flexible.csv.xls"
...
# === Guardar CSV final con POI_ID, observación y tipo de error
df_det[["POI_ID", "Observacion", "Tipo_error"]].to_csv("Clasificacion_de_sospechosos.csv", index=False)
print("✅ Archivo Clasificacion_de_sospechosos.csv generado con tipo de error.")
